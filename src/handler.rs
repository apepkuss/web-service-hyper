...
pub async fn completions_handler(_ctx: Context) -> String {
    format!("completions called")
}

pub async fn embeddings_handler(_ctx: Context) -> String {
...
pub struct CreateChatCompletionRequestBuilder {
    ...
    llama_cpp_logit_bias_type: Option<CreateChatCompletionsRequestLogitBiasType>,
}
impl CreateChatCompletionRequestBuilder {
    ...
    pub fn with_llama_cpp_logits_bias_type(
        mut self,
        logit_bias_type: CreateChatCompletionsRequestLogitBiasType,
    ) -> Self {
...
#[derive(Debug, Deserialize, Serialize)]
pub enum CreateChatCompletionsRequestLogitBiasType {
    InputIds,
    Tokens,
}
